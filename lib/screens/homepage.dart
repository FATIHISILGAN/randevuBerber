                ...
                itemBuilder: (BuildContext context, int index) {
                  return ListTile(
                    ...
                    if(seciliGun.gunAdi=="Pazartesi"){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Pazartesi()));
                    }
                    else if(seciliGun.gunAdi == "Salı") {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Sali()));
                    }
                    else if(seciliGun.gunAdi == "Çarşamba") {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Carsamba()));
                    }
                    else if(seciliGun.gunAdi == "Perşembe") {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Persembe()));
                    }
                    else if(seciliGun.gunAdi == "Cuma") {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Cuma()));
                    }
                    else if(seciliGun.gunAdi == "Cumartesi") {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Cumartesi()));
                    }
                    print(seciliGun.gunAdi);
                  },
                  );
                }),
          ),
